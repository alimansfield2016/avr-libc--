...
namespace std
{
	...
	public:
		...
		friend constexpr bool operator==(strong_ordering v, int u) noexcept { return v.value == int(eq::equal) || v.value == int(eq::equivalent); };
		friend constexpr bool operator==(strong_ordering v, strong_ordering w) noexcept = default;
		friend constexpr bool operator< (strong_ordering v, int u) noexcept { return v.value == int(ord::less); };
		friend constexpr bool operator> (strong_ordering v, int u) noexcept { return v.value == int(ord::greater); };
		friend constexpr bool operator<=(strong_ordering v, int u) noexcept { return v.value != int(ord::greater); };
		friend constexpr bool operator>=(strong_ordering v, int u) noexcept { return v.value != int(ord::less); };
		friend constexpr bool operator< (int u, strong_ordering v) noexcept { return v.value != int(ord::less); };
		friend constexpr bool operator> (int u, strong_ordering v) noexcept { return v.value != int(ord::greater); };
		friend constexpr bool operator<=(int u, strong_ordering v) noexcept { return v.value == int(ord::greater); };
		friend constexpr bool operator>=(int u, strong_ordering v) noexcept { return v.value == int(ord::less); };

		friend constexpr strong_ordering operator<=>(strong_ordering v, int u) noexcept { return v; }
		friend constexpr strong_ordering operator<=>(int u, strong_ordering v) noexcept { return v.value == int(ord::less) ? strong_ordering::greater : v.value == int(ord::greater) ? strong_ordering::less : v; };
	};
